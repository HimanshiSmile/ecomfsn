...
class _ProductGridState extends State<ProductGrid> {
  final List<Product> products = [
    Product(' Casual womens wear', 'assets/image/dress.jpg', 4.8, 236, 359.00),
    Product('Short Blue Dungry', 'assets/image/dung.jpg', 4.7, 59, 297.00),
    Product('Tuwel Grey bagy jeans', 'assets/image/jeans.jpg', 5.0, 29, 700.00), // Assuming free for demonstration
    Product('Black Bodycone Dress', 'assets/image/cone.jpg', 4.8, 163, 300.00),
    Product('Orange crop Shirt', 'assets/image/sh.jpg', 4.8, 163, 250.00),
    Product('Printed Short Dress', 'assets/image/short.jpg', 4.8, 163, 300.00)
  ];
