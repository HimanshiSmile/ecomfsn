...
class _ProductGridState extends State<ProductGrid> {
  final List<Product> products = [
    Product('White Kurta Pajama with Blue koty', 'assets/image/coty.jpg', 4.8, 236, 899.00),
    Product('Casual Kurta For boys', 'assets/image/pkurta.avif', 4.7, 59, 280.00),
    Product('Ethnic Wedding Wear ', 'assets/image/indo.jpg', 5.0, 29, 1100.00), // Assuming free for demonstration
    Product('Pink Kurta pajama with printed Koty', 'assets/image/koty.jpg', 4.8, 163, 800.00),
    Product('Trendy Kurta With Sequence work', 'assets/image/kurrtaa.jpg', 4.8, 163, 300.00),
    Product('Kurta Dhoti For Boys ', 'assets/image/kurta.jpeg', 4.8, 163, 550.00)
  ];
