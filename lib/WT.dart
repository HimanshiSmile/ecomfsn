...
class _ProductGridState extends State<ProductGrid> {
  final List<Product> products = [
    Product('White Kurta Pant with printed Bule Duptta', 'assets/image/kurtaaaa.jpg', 4.8, 236, 469.00),
    Product('Printed Cotton Lehnga', 'assets/image/leh.avif', 4.7, 59, 550.00),
    Product('Beautifully Shaded Saree', 'assets/image/saaree.jpg', 5.0, 29, 400.00), // Assuming free for demonstration
    Product('Pretty Lehnga with sequence Blouse', 'assets/image/sea.jpeg', 4.8, 163, 600.00),
    Product('Cotton Wedding Wear Printed Suit', 'assets/image/set.jpg', 4.8, 163, 850.00),
    Product('Black Pretty Suit with golden print', 'assets/image/we.jpeg', 4.8, 163, 900.00)
  ];
