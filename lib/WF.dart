...
class _ProductGridState extends State<ProductGrid> {
  final List<Product> products = [
    Product('Stylish Fancy Heel Sandal ', 'assets/image/wf.jpg', 4.8, 236, 169.00),
    Product('medifeet  footwear ', 'assets/image/wff.jpg', 4.7, 59, 187.00),
    Product('BK Deal flats sandals |', 'assets/image/wfff.jpg', 5.0, 29, 0.00), // Assuming free for demonstration
    Product('Pointed pumps', 'assets/image/wffff.jpg', 4.8, 163, 0.00),
    Product('White casual sneakers', 'assets/image/shoooooooooo.jpg', 4.8, 163, 0.00),
    Product(' Pointed-Toe Ankle-Length Boots', 'assets/image/wfffff.jpeg', 4.8, 163, 0.00)
