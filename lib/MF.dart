...
class _ProductGridState extends State<ProductGrid> {
  final List<Product> products = [
    Product(' Leather Casual Floater '
    , 'assets/image/broo.jpg', 4.8, 236, 950.00),
    Product('Victory  Running Shoes', 'assets/image/shoooo.jpg', 4.7, 59, 890.00),
    Product('The Ford Tan  Slipper Ruosh', 'assets/image/slip.jpg', 5.0, 29, 300.00), // Assuming free for demonstration
    Product('Embossed Weave Vegan Leather Shoes', 'assets/image/for.jpg', 4.8, 163, 750.00),
    Product('Outdoor Leather  Casual Shoes', 'assets/image/le.jpg', 4.8, 163, 600.00),
    Product('Comfort Flip Flop – LOFA-Love for Arcade', 'assets/image/flip.jpg', 4.8, 163, 350.00)
