...
class _ProductGridState extends State<ProductGrid> {
  final List<Product> products = [
    Product('party Wear suit for boys', 'assets/image/party.jpg', 4.8, 236, 499.00),
    Product('Casual dress for girls', 'assets/image/kw.jpg', 4.7, 59, 200.00),
    Product('Cute Tiger Printed Sweattshirt ', 'assets/image/images.jpeg', 5.0, 29, 349.00), // Assuming free for demonstration
    Product('Cute Mini SkirtTopper for girls', 'assets/image/dd.jpg', 4.8, 163, 380.00),
    Product('Pink Dungry For Girls', 'assets/image/dungr.jpg', 4.8, 163, 470.00),
    Product('Casual Capri tshirt For Boys', 'assets/image/KD.jpg', 4.8, 163, 350.00)
